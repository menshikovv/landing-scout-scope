...
const playerItems = [
  ...
  {
    q: "Что дает попадание в ТОП игроков ScoutScope?",
    a: "Попадание в ТОП-10 ScoutScope повышает заметность вашего профиля для скаутов, менеджеров и профессиональных организаций. Такие игроки получают больше внимания при поиске кандидатов и чаще рассматриваются для приглашений на просмотры, тесты и в составы команд.",
  },
  {
